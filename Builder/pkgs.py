BASE = [
    "zsh", "git", "eza", "neovim", "reflector", "yt-dlp", "fastfetch", "waybar", "kitty",
    "eva", "dunst", "brightnessctl", "gvfs", "gvfs-afc", "thunar", "tumbler", "hyprpaper",
    "mpv", "nwg-look", "otf-font-awesome-4", "ttf-font-awesome-4", "kvantum", "kvantum-qt5",
